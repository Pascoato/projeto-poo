...
public class SwingUserInterface implements IUserInterFace {
        ...
        public UserAccountDTO getUserAccountDTO() {
                ...
                String document = JOptionPane.showInputDialog(null, "Insira o doumento", "Insira o documento",
                                JOptionPane.DEFAULT_OPTION);
                userAccountDTO.setDocument(document);

                String password = JOptionPane.showInputDialog(null, "Insira a senha", "Insira a senha",
                                JOptionPane.DEFAULT_OPTION);
                userAccountDTO.setDocument(password);

                String name = JOptionPane.showInputDialog(null, "Insira o nome", "Insira o nome",
                                JOptionPane.DEFAULT_OPTION);
                userAccountDTO.setDocument(name);

                String email = JOptionPane.showInputDialog(null, "Insira o e-mail", "Insira o email",
                                JOptionPane.DEFAULT_OPTION);
        ...
        public void showExitMessage() {
                JOptionPane.showMessageDialog(null, "SAINDO", "SAINDO", JOptionPane.CLOSED_OPTION);
        }
